...
Donate link: https://secure.groundspring.org/dn/index.php?aid=1202
...
1. If using WordPress 3.0 and permalinks, you may need to update the wp-includes/canonical.php code.  See the FAQ for more information.
